...
Version: 29.3 (Fixed predict_pinn & plot_pareto_plotly)
"""
...
def generate_full_pdf_report(api, mcc, pvpp, mgst, binder, pressure, speed, granule,
    ...
    pdf.cell(0, 6, "Generated by: Hybrid AI Framework v29.3", ln=True, align="C")
...
def load_pinn_model():
    ...
    for epoch in range(adam_epochs):
        ...
        # Record training losses (physics_loss is now available)
...
# ================================================================
# 9. PREDICTION & PLOTS (FIXED)
# ================================================================

def predict_pinn(model, scaler, y_scaler, inputs):
    """
    Predict primary outputs.
    Returns: density, tensile, er, efrf
    """
    try:
        inputs_with_features = add_interaction_features(np.array([inputs]))[0]
...
st.set_page_config(page_title="PINN Framework v29.3", page_icon="🧬", layout="wide")
clamp_session_state()
...
with st.sidebar:
    ...
    **Multi-Task PINN:**
    ...
    - **Fixed predict_pinn & plot_pareto** ✅
    """)
    st.info("🔬 **v29.3** — Fixed prediction & Pareto plotting")
...
st.markdown("---")
st.caption(f"🔬 **Multi-Task True PINN — v29.3 (Fixed predict_pinn & plot_pareto_plotly)**")
