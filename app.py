...
Version: 30.0 (Balanced Physics-Data Weights, High Performance)
"""
...
# ================================================================
# 0. USER-CONFIGURABLE PARAMETERS (BALANCED FOR STABLE TRAINING)
# ================================================================
...
# ===== CRITICAL BALANCE: Physics weight reduced to 0.05 =====
PHYSICS_WEIGHT_INIT = 0.05   # was 0.3 → prevents model collapse
DATA_WEIGHT_INIT = 1.0       # was 2.0 → avoids early instability
...
class MultiTaskTruePINN(nn.Module):
    ...
    def compute_loss(self, X_scaled, X_raw, y_true, epoch=0, max_epochs=4000,
                     w_data_init=DATA_WEIGHT_INIT,  # Balanced
...
# ================================================================
# 5. DATA GENERATION (MORE SAMPLES FOR BETTER GENERALIZATION)
# ================================================================

def generate_pinn_data(n_samples=1200, random_state=42):   # Increased from 600
...
# ================================================================
# 8. TRAIN MODEL (WITH LOSS HISTORY & BALANCED WEIGHTS)
# ================================================================

@st.cache_resource
def load_pinn_model():
    df, feature_names = generate_pinn_data(n_samples=1200)  # More data
    ...
    patience = 200  # Increased patience for stable convergence
    counter = 0
    best_state = None
...
# ================================================================
# 9. PREDICTION & PLOTS (SAME AS BEFORE, KEPT FOR BREVITY)
# ================================================================

# ... (predict_pinn, plot_training_curves, plot_pareto_plotly, etc. are identical to v29.0)
# To save space, I'll include them in the full code block below.

# (The rest of the code is exactly as in v29.0, but with the updated weights, data size, and patience.)
