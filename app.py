...
Version: 29.2 (Fixed KeyError: physics_loss)
"""
...
class MultiTaskTruePINN(nn.Module):
    ...
    def compute_loss(self, X_scaled, X_raw, y_true, epoch=0, max_epochs=4000,
        ...
        loss_dict = {
            ...
            'physics_loss': physics_loss.item(),  # <-- ADDED
            'k_reg': k_reg.item(),
            'A_reg': A_reg.item(),
            'w_data': w_data,
            'w_physics': w_physics,
...
def generate_full_pdf_report(api, mcc, pvpp, mgst, binder, pressure, speed, granule,
    ...
    pdf.cell(0, 6, "Generated by: Hybrid AI Framework v29.2", ln=True, align="C")
...
st.set_page_config(page_title="PINN Framework v29.2", page_icon="🧬", layout="wide")
clamp_session_state()
...
with st.sidebar:
    ...
    **Multi-Task PINN:**
    ...
    - **Fixed physics_loss KeyError** ✅
    """)
    st.info("🔬 **v29.2** — Fixed physics_loss KeyError")
...
st.markdown("---")
st.caption(f"🔬 **Multi-Task True PINN — v29.2 (Fixed KeyError & Density Tolerance)**")
