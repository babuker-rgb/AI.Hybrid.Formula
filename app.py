...
Version: 28.6 (Fixed predict compatibility)
"""
...
# ================================================================
# 4. MULTI-TASK TRUE PINN MODEL (FIXED predict)
# ================================================================
...
class MultiTaskTruePINN(nn.Module):
    ...
    def predict(self, X_scaled, **kwargs):
        """
...
def generate_full_pdf_report(api, mcc, pvpp, mgst, binder, pressure, speed, granule,
    ...
    pdf.cell(0, 6, "Generated by: Hybrid AI Framework v28.6", ln=True, align="C")
...
# ================================================================
# 7. NSGA-II (updated to use predict without kwargs)
# ================================================================
...
# (plot functions remain identical to previous versions; omitted for brevity but present in full code)

# ================================================================
# 10. STREAMLIT UI
# ================================================================

st.set_page_config(page_title="PINN Framework v28.6", page_icon="🧬", layout="wide")
clamp_session_state()
...
with st.sidebar:
    ...
    **Multi-Task PINN:**
    ...
    """)
    st.info("🔬 **v28.6** — Fixed predict compatibility (no kwargs)")
...
st.markdown("---")
st.caption(f"🔬 **Multi-Task True PINN — v28.6 (Fixed predict compatibility)**")
